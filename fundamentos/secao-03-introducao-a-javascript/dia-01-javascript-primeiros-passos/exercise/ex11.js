...
if (salarioBase <= 1903.98) {
  ...
  aliquotImpost = (salarioBase * 0.075) - 142.80;
} else if (salarioBase <= 3751.05) {
  aliquotImpost = (salarioBase * 0.15) - 354.80;
} else if (salarioBase <= 4664.68) {
  aliquotImpost = (salarioBase * 0.225) - 636.13;
} else {
  aliquotImpost = (salarioBase * 0.275) - 869.36;
};

console.log("Salário liquido: R$" + (salarioBase - aliquotImpost).toFixed(2));
